...
const slackStrategy = require('./strategy-slack')

module.exports = {localStrategy, fbStrategy, twitterStrategy, githubStrategy,googleStrategy, lmsStrategy, slackStrategy}